        ...
        <section className='vehicles_categories'>
            <div className="vehicles_categories_blocks_wrapper">
                <div className="vehicles_categories_blocks">
                    ...
                    <Link to="/motorcycles" className="vehicle_category right_block noselect">
                    ...
                    <Link to="/special_vehicles" className="vehicle_category noselect">
                    ...
                    <Link to="/constructors" className="vehicle_category right_block noselect">
